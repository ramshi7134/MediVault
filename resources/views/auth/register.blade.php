...
<head>
    ...
    <title>Register – MediVault</title>
...
<body>
    <div class="min-h-screen flex flex-col items-center justify-center" style="background-color:#f9fafb; padding: 2rem 1rem;">
        ...
        <!-- Logo -->
        <a href="{{ url('/') }}" style="display:flex;align-items:center;gap:.5rem;margin-bottom:2rem;text-decoration:none;">
        ...
        <div class="bg-white rounded-lg shadow ring-1 p-8 w-full max-w-md" style="border:1px solid #e5e7eb;">
            <h1 class="text-2xl font-bold text-center" style="color:#111827;margin-bottom:1.5rem;">Create Your Account</h1>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- Phone (optional) -->
                <div class="mt-4">
                    <label for="phone">Phone Number <span style="color:#6b7280;font-weight:400;">(optional)</span></label>
                ...
                <!-- Submit -->
                <button type="submit"
                    style="width:100%;margin-top:1.5rem;padding:.75rem;border:none;border-radius:.375rem;font-weight:600;color:#fff;background-color:#2563eb;cursor:pointer;font-size:1rem;transition:background-color .15s;">
                    Create Account
                </button>
            </form>
            ...
            <p class="mt-6 text-center text-sm text-gray-500">
                ...
                <a href="{{ route('login') }}" class="font-medium text-blue-600 transition hover:text-blue-700">Log in here</a>
            </p>
        </div>
    </div>
</body>
